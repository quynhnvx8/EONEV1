...
public class Tabs extends org.zkoss.zul.Tabs implements EventListener<Event>
{
	...
	protected boolean isValidateDragDropComponent(Component dropComp, Component draggComp) {
		...
		if ((dropComp instanceof eone.webui.component.Tab && ((eone.webui.component.Tab)dropComp).isDisableDraggDrop())
				|| (draggComp instanceof eone.webui.component.Tab && ((eone.webui.component.Tab)draggComp).isDisableDraggDrop())
				) {
			return false;
		}
