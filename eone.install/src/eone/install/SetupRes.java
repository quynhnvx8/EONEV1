...
public class SetupRes extends ListResourceBundle
{
	...
	{ "AdempiereServerSetup", 	"EONE Server Setup" },
	{ "Ok", 					"Ok" },
	{ "File", 					"File" },
	{ "Exit", 					"Exit" },
	{ "Help", 					"Help" },
	{ "PleaseCheck", 			"Please Check" },
	{ "UnableToConnect", 		"Unable get help from EONE Web Site" },
	//
	{ "AdempiereHomeInfo", 		"EONE Home is the main Folder" },
	{ "AdempiereHome", 			"EONE Home" },
	...
	{ "DatabaseUserInfo", 		"Database EONE User ID" },
	{ "DatabaseUser", 			"Database User" },
	{ "DatabasePasswordInfo", 	"Database EONE User Password" },
	{ "DatabasePassword", 		"Database Password" },
	{ "TNSNameInfo", 			"Discovered Databases" },
	{ "TNSName", 				"Database Search" },
	{ "DBHostEx", 				"Host Server" },
	{ "DBSecond", 				"DB Second Server" },
	{ "DBNameEx", 				"Database" },
	{ "DBPortEx", 				"Port" },
	{ "DBUserEx", 				"User" },
	{ "DBPassEx",				"Password" },
	...
	{ "JNPPort", 				"JNP Port" },
	{ "MailUserInfo", 			"EONE Mail User" },
	{ "MailUser", 				"Mail User" },
	{ "MailPasswordInfo", 		"EONE Mail User Password" },
