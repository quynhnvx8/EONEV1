...
#setup eone.properties and eoneEnv.propertiess
$JAVA -jar plugins/org.eclipse.equinox.launcher_1.*.jar -install setup -configuration setup/configuration -application eone.install.application
