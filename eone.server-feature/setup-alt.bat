...
@Echo Example: cscript utils\WinEnv.js C:\EONE "C:\Program Files\Java\jdk1.5.0_04"
goto START
...
@"%JAVA%" -jar %JARFILE% -install setup -configuration setup/configuration -application eone.install.application -consoleLog
