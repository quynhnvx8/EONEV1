...
public final class DocTax
{
	 ...
	 *  @return Account
	 */
	public MElementValue getAccount (int C_Account_ID)
	{
		if (C_Account_ID < ACCTTYPE_TaxDue || C_Account_ID > ACCTTYPE_TaxExpense)
			return null;
		return MElementValue.get(Env.getCtx(), C_Account_ID);
	}   //  getAccount
