...
public class X_Fact_Reconciliation extends PO implements I_Fact_Reconciliation, I_Persistent 
{
	...
	public eone.base.model.I_Fact_Acct getFact_Acct() throws RuntimeException
    {
		return (eone.base.model.I_Fact_Acct)MTable.get(getCtx(), eone.base.model.I_Fact_Acct.Table_Name)
