...
public class X_AD_AttachmentNote extends PO implements I_AD_AttachmentNote, I_Persistent 
{
	...
	public eone.base.model.I_AD_Attachment getAD_Attachment() throws RuntimeException
    {
		return (eone.base.model.I_AD_Attachment)MTable.get(getCtx(), eone.base.model.I_AD_Attachment.Table_Name)
