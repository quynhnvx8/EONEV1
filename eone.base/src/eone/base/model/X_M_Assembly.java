...
/** Generated Model for M_Assembly
 *  @author iDempiere (generated) 
 *  @version Release 7.1 - $Id$ */
public class X_M_Assembly extends PO implements I_M_Assembly, I_Persistent 
{
    ...
    public X_M_Assembly (Properties ctx, int M_Assembly_ID, String trxName)
    {
      super (ctx, M_Assembly_ID, trxName);
      /** if (M_Assembly_ID == 0)
        {
        } */
    }
    ...
    /** Load Constructor */
    public X_M_Assembly (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_M_Assembly[")
