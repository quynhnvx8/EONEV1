...
public class MClient extends X_AD_Client
{
	...
	//Mac dinh la true. Bai toan mo rong la cau hinh theo cong ty trong truong hop
	//Co ke toan CO con Ke toan truong PO hach toan.
	//Khai them truong o clientInfo va cau hinh theo clientInfo
	public static boolean isClientPostImmediate() {
		return true;
