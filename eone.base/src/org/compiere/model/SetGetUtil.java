	...
	public static SetGetModel wrap(Object o)
	{
		...
		else if (o instanceof SetGetModel && !(o instanceof Proxy))
		{
			return (SetGetModel)o;
				...
				&& Proxy.getInvocationHandler(o) instanceof org.compiere.model.GridTabWrapper)
		{
			org.compiere.model.GridTabWrapper gtw = (org.compiere.model.GridTabWrapper)Proxy.getInvocationHandler(o);
