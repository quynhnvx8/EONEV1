...
public class TaxForChangeNotFoundException extends AdempiereException
{
	...
	{
		super(buildMessage(C_Charge_ID, AD_Org_ID, M_Warehouse_ID,additionalMsg));
	}
	
	private static final String buildMessage(int C_Charge_ID, int AD_Org_ID, int M_Warehouse_ID, String additionalMsg)
	{
